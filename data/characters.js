const CHARACTERS = [
  ...
  { name: "Concha de la Fuente", type: "Principal",gender: "Femenino",  nationality: "Española", floors: ["2º B","1º A"],          seasons: [1,2,3,4,5], occupations: ["Jubilada","Propietaria inmobiliaria"] },

  // 1º B
  { name: "Mauri Hidalgo",     type: "Principal",  gender: "Masculino", nationality: "Española", floors: ["1º B"],                 seasons: [1,2,3,4,5], occupations: ["Periodista","Abogado"] },
  ...
  { name: "Bea Villarejo",     type: "Principal",  gender: "Femenino",  nationality: "Española", floors: ["1º B"],                 seasons: [2,3,4,5],   occupations: ["Profesora"] },

  // 2º A
  { name: "Juan Cuesta",       type: "Principal",  gender: "Masculino", nationality: "Española", floors: ["2º A","3º A"],          seasons: [1,2,3,4,5], occupations: ["Profesor de primaria","Presidente comunidad","Director de academia"] },
  { name: "Paloma Hurtado",    type: "Principal",  gender: "Femenino",  nationality: "Española", floors: ["2º A"],                 seasons: [1,2],       occupations: ["Ama de casa"] },
  { name: "Natalia Cuesta",    type: "Principal",  gender: "Femenino",  nationality: "Española", floors: ["2º A","Ático"],         seasons: [1,2,3,4,5], occupations: ["Estudiante de psicología","Madre de alquiler"] },
  ...
  // 3º A
  { name: "Lucía Álvarez",     type: "Principal",  gender: "Femenino",  nationality: "Española", floors: ["3º A"],                 seasons: [1,2,3,4],   occupations: ["Abogada","Voluntaria ONG"] },
  ...
  { name: "Nieves Cuesta",     type: "Secundario", gender: "Femenino",  nationality: "Española", floors: ["2º B","3º A"],          seasons: [3,4],       occupations: ["Funcionaria"] },
  ...
  // VIDEOCLUB
  { name: "Paco",              type: "Principal",  gender: "Masculino", nationality: "Española", floors: ["Videoclub","Ático"],    seasons: [1,2,3,4,5], occupations: ["Empleado de videoclub","Dueño del videoclub"] },
